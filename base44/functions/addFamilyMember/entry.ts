    ...
    try {
      await base44.integrations.Core.SendEmail({
        ...
        body: [
          ...
          ``,
          `To accept and activate your protection, create your free Vardin account here:`,
          registerUrl,
          ``,
          `Once you're in, you'll see ${user.full_name || 'your family member'} listed as your guardian and you'll get all the plan benefits automatically.`,
          ``,
          `Stay safe,`,
          `The Vardin Team`,
        ].join('\n'),
