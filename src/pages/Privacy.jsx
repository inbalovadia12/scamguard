...
export default function Privacy() {
  const sections = [
    ...
    },
    {
      ...
      body: "Vardin's scam detection uses artificial intelligence and other automated systems. These are automated predictions and pattern-based assessments that may be inaccurate, incomplete, delayed, or based on information that has changed. A low-risk or \"safe\" result does not guarantee that a call, message, link, website, image, person, business, wallet, or transaction is safe or legitimate. A high-risk or \"scam\" result does not by itself prove fraud or malicious intent. Confidence scores and risk scores are not guarantees of accuracy.\n\nVardin's AI output is provided for informational and educational purposes only. Users should independently verify important information and should not rely solely on Vardin for financial, legal, medical, security, identity-theft, tax, investment, insurance, or other high-stakes decisions. For important or urgent matters, contact the relevant organization, bank, platform, authority, or qualified professional directly using a trusted contact method. See the Terms of Service for additional AI limitations and service terms.", 
    },
    {
      icon: Trash2,
