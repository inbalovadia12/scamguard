      ...
      {outOfCredits && !result && (
        <div className="mb-6 p-6 rounded-2xl bg-warning/10 border border-warning/20 text-center space-y-3">
          ...
          <p className="text-sm text-muted-foreground">
            You've used all {credits.limit} of your monthly credits. Upgrade for more analyses, screenshot analysis, AI chat, and family protection.
          </p>
          <Link to="/pricing">
      ...
      {!result ? (
        <div className="space-y-8">
          <div className="text-center space-y-3">
            ...
            <h1 className="text-3xl font-bold tracking-tight font-heading">Check a Suspicious Message</h1>
          ...
          <div className="bg-card rounded-3xl border border-border/50 shadow-sm p-6 space-y-5">
            ...
            <Button
              ...
              className="w-full h-12 text-base font-semibold rounded-xl bg-gradient-to-r from-primary to-primary/80 shadow-md shadow-primary/20"
              size="lg"
            >
              {analyzing ? (
                <>
          ...
          <div className="flex items-center justify-center gap-6 text-xs text-muted-foreground">
            <span>🔒 Messages are auto-redacted before storage</span>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-card rounded-2xl border border-border/50 p-4">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed whitespace-pre-wrap">{messageText}</p>
          </div>
