...
import { Shield, Loader2, ArrowRight, MessageSquare, Mail, Briefcase, ShoppingCart, Heart, Landmark, HelpCircle } from "lucide-react";
        ...
        <div className="space-y-8">
          ...
          <div className="bg-white rounded-3xl border border-border/50 shadow-sm p-6 space-y-5">
            ...
            <Button
              ...
              className="w-full h-13 text-base font-semibold rounded-xl bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 shadow-md shadow-blue-500/20"
              size="lg"
            >
              {analyzing ? (
                <>
