  ...
  return (
    <div className="max-w-5xl mx-auto pb-16">
      <header className="border-b border-border/60 pb-8 sm:pb-10">
        ...
        <h1 className="mt-3 text-3xl sm:text-4xl font-bold tracking-tight">Data Collection Notice</h1>
      ...
      <section className="py-8 border-b border-border/60 space-y-4 text-sm sm:text-[15px] leading-7 text-muted-foreground">
