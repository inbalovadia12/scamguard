...
- red_flag_messages: array of strings, each describing a specific suspicious message and WHY it's a red flag (e.g., '"I need $500 for my flight" — Requesting money from someone you just met online is a classic romance scam sign')
...
Respond entirely in ${langName}.`;
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-5 sm:space-y-6 pb-8">
      ...
      {/* Input */}
      <div className="bg-card rounded-2xl border border-border/50 p-4 sm:p-5 space-y-4 animate-slide-up" style={{ animationDelay: "50ms" }}>
        <div>
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3 min-w-0 flex-1">
                    <div className={`w-9 h-9 rounded-xl ${riskCfg?.bg || "bg-muted"} flex items-center justify-center flex-shrink-0`}>
                      <MessagesSquare className={`w-4 h-4 ${riskCfg?.color || "text-muted-foreground"}`} />
                    </div>
