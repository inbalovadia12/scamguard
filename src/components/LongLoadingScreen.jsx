...
const THEMES = {
  ...
  universal: {
    title: "Running Universal Scam Scan",
    gradient: "from-primary to-primary/80",
    estimatedDuration: 18000,
    steps: [
      { label: "Preparing your scan inputs...", at: 0 },
      { label: "Inspecting the content and page signals...", at: 18 },
      { label: "Checking phishing and manipulation patterns...", at: 36 },
      { label: "Comparing threat-intelligence evidence...", at: 55 },
      { label: "Evaluating the strongest risk indicators...", at: 72 },
      { label: "Building your security report...", at: 88 },
      { label: "Finalizing the verdict...", at: 96 },
    ],
  },
  cryptoLink: {
    title: "Investigating Crypto Link",
    gradient: "from-amber-500 via-primary to-primary/80",
    estimatedDuration: 15000,
    steps: [
      { label: "Opening the crypto destination safely...", at: 0 },
      { label: "Checking domain and redirect behavior...", at: 18 },
      { label: "Comparing phishing and wallet-drain signals...", at: 36 },
      { label: "Checking security-engine reputation...", at: 55 },
      { label: "Reviewing the page for crypto-specific traps...", at: 72 },
      { label: "Weighing the evidence...", at: 88 },
      { label: "Preparing your crypto verdict...", at: 96 },
    ],
  },
  cryptoInvestment: {
    title: "Analyzing Crypto Investment Message",
    gradient: "from-amber-500 via-primary to-primary/80",
    estimatedDuration: 12000,
    steps: [
      { label: "Reading the full investment message...", at: 0 },
      { label: "Identifying pressure and persuasion tactics...", at: 18 },
      { label: "Checking giveaway and airdrop warning signs...", at: 38 },
      { label: "Examining what the sender wants you to do...", at: 58 },
      { label: "Scoring the actual scam risk...", at: 78 },
      { label: "Writing your recommended next steps...", at: 92 },
    ],
  },
  scanner: {
    ...
    steps: [
      ...
      { label: "Detecting manipulation tactics...", at: 20 },
      { label: "Analyzing for phishing patterns...", at: 40 },
      { label: "Cross-referencing scam patterns...", at: 60 },
      { label: "Evaluating risk factors...", at: 80 },
      { label: "Compiling your report...", at: 92 },
    ],
  },
  image: {
  ...
  phone: {
    title: "Searching the Web for Reports",
    gradient: "from-primary to-primary/80",
    estimatedDuration: 30000,
    steps: [
      { label: "Validating phone number...", at: 0 },
      { label: "Checking known databases...", at: 3 },
      { label: "Searching for scam reports...", at: 8 },
      { label: "Checking Vardin Community evidence...", at: 15 },
      { label: "Checking Reddit r/ScamNumbers...", at: 25 },
      { label: "Analyzing fraud signals...", at: 50 },
      { label: "Calculating risk score...", at: 70 },
      { label: "Finalizing result...", at: 90 },
    ],
  },
  local: {
