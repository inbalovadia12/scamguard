...
export default function ScamFeedPanel() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-end animate-slide-up">
        <Button onClick={() => setDialogOpen(true)} className="gap-2 bg-gradient-to-r from-primary to-primary/80 shadow-md shadow-primary/20">
